...
const projects = [
  {
    title: 'Warden',
    description: 'A centralized security monitoring platform for SOC analysts to monitor threats, investigate incidents, and manage security alerts. Engineered with Docker containerization, robust backend services, and active monitoring for operational visibility.',
    tags: ['React', 'Node.js', 'PostgreSQL', 'JWT', 'Chart.js', 'Docker'],
    icon: Shield,
    accent: '#3B82F6',
    featured: true,
    status: 'Production',
    category: 'Security / Infrastructure',
    features: ['Docker Containerization', 'Backend Monitoring', 'Database Integration', 'Operational Visibility'],
    github: 'https://github.com/abhay275',
    demo: '#',
  },
  {
    title: 'RideNova',
    description: 'Real-time ride-booking platform with trip management, location tracking, and geospatial driver matching. Built with a service-oriented architecture, focusing on reliable backend service deployment and efficient environment configuration.',
    tags: ['Flutter', 'FastAPI', 'Redis', 'S2 Geometry'],
    icon: BarChart3,
    accent: '#06B6D4',
    featured: true,
    status: 'Beta',
    category: 'Backend Architecture',
    features: ['Service Deployment', 'API Integration', 'Environment Config', 'Real-time Services'],
    github: 'https://github.com/abhay275',
    demo: '#',
  },
  {
    title: 'AVSAR',
    description: 'Architected a personalized career and education advisor with a strong backend API architecture. Implemented reliable REST APIs, database integration with PostgreSQL, and automated deployment workflows.',
    ...
    features: ['API Architecture', 'Frontend Integration', 'Deployment Workflow'],
    github: 'https://github.com/abhay275/Personalized-Career-Advisor',
    demo: 'https://collaborate-create-code.vercel.app/',
  },
  {
    title: 'ShareBox',
    description: 'Designed a secure file-sharing social impact platform with reliable frontend/backend communication, managed environment configurations, and production deployment workflows.',
    ...
    features: ['REST APIs', 'Production Workflows', 'Service Reliability'],
    github: 'https://github.com/abhay275',
    demo: '#',
  },
];
